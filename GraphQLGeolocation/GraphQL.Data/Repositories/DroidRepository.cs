...
namespace GraphQL.Data.Repositories
{
    public class DroidRepository : IDroidRepository
    {
        ...
        public Task<List<Droid>> GetDroidsAsync(int? first, DateTime? createdAfter,
        ...
        public Task<List<Droid>> GetDroidsReverseAsync(int? last, DateTime? createdBefore, CancellationToken cancellationToken)
            =>
                Task.FromResult(Database.Droids
