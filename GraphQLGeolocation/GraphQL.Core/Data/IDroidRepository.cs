...
namespace GraphQL.Core.Data
{
    public interface IDroidRepository
    {
        ...
        Task<List<Droid>> GetDroidsAsync(int? first, DateTime? createdAfter, CancellationToken cancellationToken);
        
        Task<List<Droid>> GetDroidsReverseAsync(int? last, DateTime? createdBefore, CancellationToken cancellationToken);
